...
using SMS_Project_MVC.Models;

namespace SMS_Project_MVC.Controllers
{
    public class RegistrationsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "id,firstname,lastname,course_id,batch_id,phone_no")] registration registration)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "id,firstname,lastname,course_id,batch_id,phone_no")] registration registration)
        {
            if (ModelState.IsValid)
            {
